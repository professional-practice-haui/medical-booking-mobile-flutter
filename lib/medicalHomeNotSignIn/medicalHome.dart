...
import 'package:medical_booking_app/medicalHomeNotSignIn/listDoctor.dart';
import 'package:medical_booking_app/medicalHomeNotSignIn/navbarMedicalHome.dart';
...
class MedicalHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          NavbarMedicalHome(imageWidth: screenWidth, imageHeight: screenHeight/3.5),
          Row(
            children: [
              const Icon(
                Icons.person,
