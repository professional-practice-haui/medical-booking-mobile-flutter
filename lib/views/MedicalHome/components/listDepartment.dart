...
class ListDepartment extends StatelessWidget {
  ...
  final List<Department> departments = List.generate(8, (index) => Department(departmentId: "${index+1}", avatar: "assets/images/tim-mach.jpg", name: "Khoa${index+1}", year: index+1));
  @override
          ...
          children: [
            Row(
              children: [
                ...
                SizedBox(width: 5,),
                Text("Khám theo chuyên khoa",style: TextStyle(fontWeight: FontWeight.bold),)
              ],
            ),
            SizedBox(height: 10,),
            GridView.builder(
